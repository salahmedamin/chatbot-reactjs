...
function Lang() {
  ...
  return (
    <div className="py-1 relative flex cursor-pointer items-center justify-center mr-5">
      <div
        ...
        style={{
          ...
          height: 30,
          backgroundImage:
            "url("+langs.find(a=>a.key===selected.current).flag+")",
      ...
      >
        <FontAwesomeIcon
          icon={faArrowDown}
          className="text-gray-700 transform scale-75"
        />
      </div>
